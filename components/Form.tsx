      ...
      {({ handleChange, handleBlur, handleSubmit, values, errors, touched, setFieldValue }) => (
        <ScrollView style={styles.container}>
          ...
          {[
            ...
            <View key={opt} style={styles.checkboxContainer}>
              <Checkbox
                value={values.diarrhoea === opt}
                onValueChange={() => setFieldValue('diarrhoea', opt)}
              />
              <Text>{opt}</Text>
            </View>
          ))}
          ...
          {[
            ...
            <View key={opt} style={styles.checkboxContainer}>
              <Checkbox
                value={values.diarrhoeaAction === opt}
                onValueChange={() => setFieldValue('diarrhoeaAction', opt)}
              />
              <Text>{opt}</Text>
            </View>
          ))}
          ...
          {[
            ...
            <View key={opt} style={styles.checkboxContainer}>
              <Checkbox
                value={values.coldLookLike === opt}
                onValueChange={() => setFieldValue('coldLookLike', opt)}
              />
              <Text>{opt}</Text>
            </View>
          ))}
          ...
          {[
            ...
            <View key={opt} style={styles.checkboxContainer}>
              <Checkbox
                value={values.mskInjury === opt}
                onValueChange={() => setFieldValue('mskInjury', opt)}
              />
              <Text>{opt}</Text>
            </View>
          ))}
          ...
          {[
            ...
            <View key={opt} style={styles.checkboxContainer}>
              <Checkbox
                value={values.hypertension === opt}
                onValueChange={() => setFieldValue('hypertension', opt)}
              />
              <Text>{opt}</Text>
            </View>
          ))}
          ...
          {[
            ...
            <View key={opt} style={styles.checkboxContainer}>
              <Checkbox
                value={values.cholesterol === opt}
                onValueChange={() => setFieldValue('cholesterol', opt)}
              />
              <Text>{opt}</Text>
            </View>
          ))}
          ...
          {[
            ...
            <View key={opt} style={styles.checkboxContainer}>
              <Checkbox
                value={values.diabetes === opt}
                onValueChange={() => setFieldValue('diabetes', opt)}
              />
              <Text>{opt}</Text>
            </View>
          ))}
          ...
          {['Yes', 'No'].map((opt) => (
            <View key={opt} style={styles.checkboxContainer}>
              <Checkbox
                value={values.handBeforeMeal === opt}
                onValueChange={() => setFieldValue('handBeforeMeal', opt)}
              />
              <Text>{opt}</Text>
            </View>
          ))}
          ...
          {['Yes', 'No'].map((opt) => (
            <View key={opt} style={styles.checkboxContainer}>
              <Checkbox
                value={values.handAfterToilet === opt}
                onValueChange={() => setFieldValue('handAfterToilet', opt)}
              />
              <Text>{opt}</Text>
            </View>
          ))}
          ...
          {['Agree', 'Disagree'].map((opt) => (
            <View key={opt} style={styles.checkboxContainer}>
              <Checkbox
                value={values.eatCleanFood === opt}
                onValueChange={() => setFieldValue('eatCleanFood', opt)}
              />
              <Text>{opt}</Text>
            </View>
          ))}
          ...
          {['Yes', 'No'].map((opt) => (
            <View key={opt} style={styles.checkboxContainer}>
              <Checkbox
                value={values.knowWaterFilters === opt}
                onValueChange={() => setFieldValue('knowWaterFilters', opt)}
              />
              <Text>{opt}</Text>
            </View>
          ))}
